...
public class ViewAllCourseGUI {
    ...
    public ViewAllCourseGUI(Runnable onBack) {
        this.onBack = onBack;

        jFrame = new JFrame("View All Courses ");
        ...
        studentsTable.setBounds(30, 40, 200, 400);
